		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="mainheading">
					...
					<p class="lead">Asigne tareas y seguimientos a los empleados del equipo de ventas para coordinar eficientemente las actividades diarias y garantizar un servicio al cliente óptimo.</p>
				</div>
				<form action="registTareas.php" method="post" id="taskForm">
					...
					<div class="form-group">
						<label for="fechalimit">Fecha Límite:</label>
						<input type="date" placeholder="Fecha limite" class="form-control" name="fechalimit" id="fechalimit" required>
					</div>
					<button type="submit" class="btn btn-primary" name="register">Asignar Tarea</button>
				</form>
				<br>
							...
							<table>
								...
								?>
									<tr>
										...
										<td><?php echo $row->fechalimit; ?></td>
										<td>

											<a class="btn btn-primary" href="editar2.php?id=<?php echo $row->id; ?>"><i class="fa fa-pencil fa-lg"></i></a>
											<a class="btn btn-primary" href="borrar2.php?id=<?php echo $row->id; ?>"><i class="fa fa-trash-o fa-lg"></i></a>
