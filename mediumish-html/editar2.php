...
<body>
    <div class="main-wrapper">
        ...
        <form action="" method="post">
            ...
            <input type="text" value="<?php echo $row->fechalimit; ?>" name="fechalimit">
        ...
        if (isset($_POST['submit'])) {
            $field = array("empleado" => $_POST['empleado'], "descripcion" => $_POST['descripcion'], "fechalimit" => $_POST['fechalimit']);
            $tbl = "tareas";
